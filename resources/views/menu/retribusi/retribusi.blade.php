                    ...
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h6 class="font-extrabold mb-0">
                                    {{ indonesianCurrency($filteredResult['totalLunas']) }}
                                </h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-stat">
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <h6 class="text-muted font-semibold">Nunggak</h6>
                                <h6 class="font-extrabold mb-0">
                                    {{ indonesianCurrency($filteredResult['totalNunggak']) }}
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-sm text-center caption-top" id="datatable">
                            <caption>Laporan data dari tanggal <span
                                    class="fw-bold">{{ $filteredResult['start_date'] }}</span> -
                                <span class="fw-bold">{{ $filteredResult['end_date'] }}</span>, Pasar <span
                                    class="fw-bold">{{ $filteredResult['namaPasar'] }}</span>, Bagian <span
                                    class="fw-bold">{{ $filteredResult['namaBagian'] }}</span>
                            </caption>
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
