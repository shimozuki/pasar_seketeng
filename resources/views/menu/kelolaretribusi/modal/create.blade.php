                        ...
                        <div class="col-sm-12 col-md-12">  
                            <div class="mb-3">  
                                ...
                                <select class="form-select" name="status" id="status">  
                                    ...
                                    <option value="nunggak" {{ old('status') == 'nunggak' ? 'selected' : '' }}>Nunggak</option>  
                                </select>  
                            </div>  
                        </div>  
                    </div>  
  
                    <div class="row" id="jumlahRow" style="{{ old('status') == 'nunggak' ? 'display: none;' : '' }}">  
                        <div class="col-sm-12 col-md-12">  
                            <div class="mb-3">  
...
<script>  
    document.addEventListener('DOMContentLoaded', function() {  
        ...
        function toggleJumlahRow() {  
            if (statusSelect.value === 'nunggak') {  
                jumlahRow.style.display = 'none';  
            } else {  
                jumlahRow.style.display = '';  
            }  
        }  
